...
namespace Avanpost.Interviews.Task.Integration.SandBox.Tests
{
    public class UnitTest1
    {
        ...
        static string mssqlConnectionString = @"Server=myServerName\myInstanceName;Database=myDataBase;User Id=myUsername;Password=myPassword;";
        ...
        public void CreateUser(string provider)
        {
            ...
            //{
            //    Properties = new UserProperty[] { new UserProperty("isLead", "false") }.ToList()
            //});
